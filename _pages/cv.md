...
* **Y. Zhao** et al, Graph Distribution-valued Signals: A Wasserstein Space Perspective, ICASSP 2026.
...
* F. Ji<sup>1</sup>, **Y. Zhao**<sup>1</sup>(equal contribution) et all, Rethinking graph neural networks from a geometric perspective of node features, ICLR 2025.
* **Y. Zhao** et al, Generalized graph signal reconstruction via the uncertainty principle, ICASSP 2025.
